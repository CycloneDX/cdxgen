...
| CDXGEN_NO_CACHE                             | Set to `true` or `1` to disable the `cache` option for the HTTP request agent.                                                                                                                                                              |
...
| JAVA8_TOOL                                  | Specifies the Java 8 toolchain version to use. Defaults to `8.0.452-amzn` if not explicitly set. Can be overridden to point to a custom Java 8 version.                                                                                     |
| JAVA11_TOOL                                 | Specifies the Java 11 toolchain version to use. Defaults to `11.0.27-tem` if not explicitly set. Can be overridden to point to a custom Java 11 version.                                                                                    |
| JAVA17_TOOL                                 | Specifies the Java 17 toolchain version to use. Defaults to `17.0.15-tem` if not explicitly set. Can be overridden to point to a custom Java 17 version.                                                                                    |
