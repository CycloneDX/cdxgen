...
const mixins = [
  (await import("./load-actual.js")).default,
  (await import("./load-virtual.js")).default,
];

const _setWorkspaces = Symbol.for("setWorkspaces");
const Base = mixins.reduce(
  (a, b) => b(a),
  (await import("node:events")).EventEmitter,
);
...
class Arborist extends Base {
  constructor(options = {}) {
    ...
    this.options = {
      ...
      formatPackageLock:
        "formatPackageLock" in options ? !!options.formatPackageLock : true,
      force: !!options.force,
      global: !!options.global,
      ignoreScripts: !!options.ignoreScripts,
      installStrategy: options.global
        ? "shallow"
        : options.installStrategy
          ? options.installStrategy
          : "hoisted",
      ...
      path: options.path || ".",
      rebuildBundle:
        "rebuildBundle" in options ? !!options.rebuildBundle : true,
    ...
    this.replaceRegistryHost = this.options.replaceRegistryHost =
      !this.options.replaceRegistryHost ||
