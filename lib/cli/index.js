          ...
          for (const apj of wpkgJsonFiles) {
            ...
            if (pkgData?.name) {
              ...
              if (!workspacePackages.includes(workspaceRef)) {
                ...
                console.log(
                  `Found a duplicate workspace with the name: ${pkgData.name}, ref: ${workspaceRef} at ${relativePkgJsonFile} and ${workspaceSrcFiles[workspaceRef]}. This is likely an error in the project.`,
                );
