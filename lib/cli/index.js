...
export async function createNodejsBom(path, options) {
  ...
  const npmInstallCount = Number.parseInt(process.env.NPM_INSTALL_COUNT) || 3;
  // Automatic npm install logic.
  // Only perform npm install for smaller projects (< 3 package.json) without the correct number of lock files
  if (
