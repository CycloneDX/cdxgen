...
import cosDbQueries from "../../data/cosdb-queries.json" assert {type: "json"};
import winOsQueries from "../../data/queries-win.json" assert {type: "json"};
import darwinOsQueries from "../../data/queries-darwin.json" assert {type: "json"};
import defaultOsQueries from "../../data/queries.json" assert {type: "json"};
