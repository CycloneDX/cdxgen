...
const { default: frameworksListJson } = await import(
  "../../data/frameworks-list.json",
  importConfig
);
const { default: CPP_STD_MODULES } = await import(
  "../../data/glibc-stdlib.json",
  importConfig
);
const { default: knownLicenses } = await import(
  "../../data/known-licenses.json",
  importConfig
);
const { default: licenseMapping } = await import(
  "../../data/lic-mapping.json",
  importConfig
);
const { default: spdxLicenses } = await import(
  "../../data/spdx-licenses.json",
  importConfig
);
const { default: vendorAliases } = await import(
  "../../data/vendor-alias.json",
  importConfig
);
const { default: mesonWrapDB } = await import(
  "../../data/wrapdb-releases.json",
  importConfig
);
const { default: selfPJson } = await import("../../package.json", importConfig);
...
const { default: PYTHON_STD_MODULES } = await import(
  "../../data/python-stdlib.json",
  importConfig
);

// Mapping between modules and package names
const { default: PYPI_MODULE_PACKAGE_MAPPING } = await import(
...
const { default: RUBY_KNOWN_MODULES } = await import(
  "../../data/ruby-known-modules.json",
  importConfig
);
