...
const vendorAliases = JSON.parse(
  readFileSync(
    join(dirNameStr, "../../", "data", "vendor-alias.json"),
    "utf-8",
  ),
);
const spdxLicenses = JSON.parse(
  readFileSync(
    join(dirNameStr, "../../", "data", "spdx-licenses.json"),
    "utf-8",
  ),
);
const knownLicenses = JSON.parse(
  readFileSync(
    join(dirNameStr, "../../", "data", "known-licenses.json"),
    "utf-8",
  ),
);
const mesonWrapDB = JSON.parse(
  readFileSync(
    join(dirNameStr, "../../", "data", "wrapdb-releases.json"),
    "utf-8",
  ),
);
export const frameworksList = JSON.parse(
  readFileSync(
    join(dirNameStr, "../../", "data", "frameworks-list.json"),
    "utf-8",
  ),
);
...
const CPP_STD_MODULES = JSON.parse(
  readFileSync(
    join(dirNameStr, "../../", "data", "glibc-stdlib.json"),
    "utf-8",
  ),
);
...
const PYTHON_STD_MODULES = JSON.parse(
  readFileSync(
    join(dirNameStr, "../../", "data", "python-stdlib.json"),
    "utf-8",
  ),
);
