...
import frameworksListJson from "../../data/frameworks-list.json" assert {
  type: "json",
};
import CPP_STD_MODULES from "../../data/glibc-stdlib.json" assert {
  type: "json",
};
import knownLicenses from "../../data/known-licenses.json" assert {
  type: "json",
};
import licenseMapping from "../../data/lic-mapping.json" assert {
  type: "json",
};
import spdxLicenses from "../../data/spdx-licenses.json" assert {
  type: "json",
};
import vendorAliases from "../../data/vendor-alias.json" assert {
  type: "json",
};
import mesonWrapDB from "../../data/wrapdb-releases.json" assert {
  type: "json",
};
...
import PYTHON_STD_MODULES from "../../data/python-stdlib.json" assert {
  type: "json",
};

// Mapping between modules and package names
import PYPI_MODULE_PACKAGE_MAPPING from "../../data/pypi-pkg-aliases.json" assert {
  type: "json",
};
...
import RUBY_KNOWN_MODULES from "../../data/ruby-known-modules.json" assert {
  type: "json",
};
