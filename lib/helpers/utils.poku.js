...
it("parsePnpmLock", async () => {
  ...
  assert.deepStrictEqual(parsedList.dependenciesList.length, 377);
...
const testCases = [
  ...
  ["http://[2001:db8::1]/path", false], // Valid IPv6 without port
  ...
  ["https://example.com/search?q=café%20röst", false],
