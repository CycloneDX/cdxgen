...
import { ATOM_DB } from "./helpers/utils.js";
import { validateBom } from "./helpers/validator.js";
import { postProcess } from "./postgen/index.js";
...
(async () => {
  ...
  if (options.evidence || options.includeCrypto) {
    const evinserModule = await import("./evinser/index.js");
    const evinseOptions = {
      _: args._,
  ...
  if (options.exportProto) {
    const protobomModule = await import("./helpers/protobom.js");
