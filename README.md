...
| UV_THREADPOOL_SIZE           | libuv provides a threadpool which is internally used to run all file system operations, as well as getaddrinfo and getnameinfo requests. Default value is 4 with maximum of 1024. Recommended value is 512. |
